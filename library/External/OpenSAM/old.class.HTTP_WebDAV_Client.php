...
');
    ...
    function _parse_url($url) 
    {
        ...
        if(!isset($url_parsed['scheme'])){
        	throw new Exception("no scheme in parsed URL: " . print_r($url_parsed, true));
        }
        ...
        default:
            $this->errmessage = "only 'webdav:' and 'webdavs:' are supported, given: " . print_r($url_parsed, true);
