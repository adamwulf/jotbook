<?php
// ybrowserauth.class.php5 -- a PHP5 class for using Yahoo's browser
// authentication service
//
// Author: Jason Levitt
// September 18th, 2006 Version 0.98c
...
class YBrowserAuth {
	...
	private function getAccessURL() {
		...
		return $this->createAuthURL(self::wslogin_prefix . "wspwtoken_login?token=$this->token&appid=$this->appid");
	}
	 ...
	 */
	private function createAuthURL($url) {
		// Take apart the URL
		$parts = parse_url($url);
	 ...
	 */
	private function getAccessCredentials() {
